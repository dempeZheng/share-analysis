 ...
 */
public class Hourly extends BaseAction {
    ...
    private JSONArray sumDailyReport(String _appkey, Map<String, List<String>> params) {
        ...
        String _create_date = DateUtils.getHouryRegx(_startDate, _endDate);
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                int createDate = Integer.parseInt(cols[1].substring(0, 8));
